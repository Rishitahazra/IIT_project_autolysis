    ...
    "messages": [
        {
            ...
            "content": [{"type": "text", "text":prompt},
                        ...
                        {"type": "image_url", "image_url": { "url": f"data:image/png;base64,{list_base64_image[1]}"}},
                        {"type": "image_url", "image_url": { "url": f"data:image/png;base64,{list_base64_image[2]}"}},
                        {"type": "image_url", "image_url": { "url": f"data:image/png;base64,{list_base64_image[3]}"}},
                        {"type": "image_url", "image_url": { "url": f"data:image/png;base64,{list_base64_image[4]}"}},
                        {"type": "image_url", "image_url": { "url": f"data:image/png;base64,{list_base64_image[5]}"}}
                        ]  
        },
